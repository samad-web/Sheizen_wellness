...
const formSchema = z.object({
    ...
    personal: z.object({
        ...
        age_gender: z.string().min(1, "Required"),
        contact: z.union([z.string(), z.number()]).transform((val) => String(val)).refine(val => val.length > 0, "Required"),
        occupation: z.string().min(1, "Required"),
        marital_status: z.string().min(1, "Required"),
        address: z.string().min(1, "Required"),
        lifestyle: z.enum(["Sedentary", "Moderate", "Heavy"]),
        date_of_assessment: z.string().min(1, "Required"),
        purpose_of_visit: z.string().min(1, "Required"),
        referrals: z.string().min(1, "Required"),
    }),
    anthropometric: z.object({
        height: z.string().min(1, "Required"),
        weight: z.string().min(1, "Required"),
        bmi: z.string().min(1, "Required"),
        waist_circumference: z.string().min(1, "Required"),
        hip_circumference: z.string().min(1, "Required"),
        waist_hip_ratio: z.string().min(1, "Required"),
        muac: z.string().min(1, "Required"),
        ideal_body_weight: z.string().min(1, "Required"),
        weight_change_percent: z.string().min(1, "Required"),
        body_fat_percent: z.string().min(1, "Required"),
        growth_percentile: z.string().min(1, "Required"),
        interpretation: z.array(z.string()).min(1, "Select at least one"),
    }),
    biochemical: z.object({
        fbs_ppbs: z.string().min(1, "Required"),
        hba1c: z.string().min(1, "Required"),
        lipid_profile: z.string().min(1, "Required"),
        hemoglobin: z.string().min(1, "Required"),
        vitamin_d: z.string().min(1, "Required"),
        vitamin_b12: z.string().min(1, "Required"),
        serum_iron_ferritin: z.string().min(1, "Required"),
        serum_calcium: z.string().min(1, "Required"),
        thyroid_function: z.string().min(1, "Required"),
        lft_rft: z.string().min(1, "Required"),
        hormone: z.string().min(1, "Required"),
        others: z.string().min(1, "Required"),
        interpretation: z.string().min(1, "Required"),
    }),
    clinical: z.object({
        general_appearance: z.string().min(1, "Required"),
        skin_hair_nails: z.string().min(1, "Required"),
        eyes: z.string().min(1, "Required"),
        oral_cavity: z.string().min(1, "Required"),
        edema_dehydration: z.string().min(1, "Required"),
        appetite: z.enum(["Good", "Moderate", "Poor"]),
        bowel_habits: z.enum(["Regular", "Constipation", "Loose stools"]),
        digestive_issues: z.string().min(1, "Required"),
        bloating_etc: z.string().min(1, "Required"),
        menstrual_history: z.string().min(1, "Required"),
        sleep_pattern: z.string().min(1, "Required"),
        stress_anxiety: z.string().min(1, "Required"),
        physical_activity_level: z.enum(["Sedentary", "Moderate", "Active"]),
        medical_history: z.string().min(1, "Required"),
        family_history: z.string().min(1, "Required"),
        current_medications: z.string().min(1, "Required"),
    }),
    dietary: z.object({
        diet_preference: z.string().min(1, "Required"),
        cooking_responsibility: z.string().min(1, "Required"),
        skipping_meals: z.string().min(1, "Required"),
        recall_24hr: z.string().min(1, "Required"),
    }),
    ffq: z.record(z.string(), z.string().min(1, "Frequency required")),
    lifestyle: z.object({
        meal_timing: z.enum(["Regular", "Irregular"]),
        water_intake: z.enum(["<4", "4-8", ">8"]),
        eating_speed: z.enum(["Fast", "Medium", "Slow"]),
        emotional_eating: z.enum(["Yes", "No"]),
        outside_food_frequency: z.enum(["Daily", "Weekly", "Rare"]),
        cooking_oil: z.array(z.string()).min(1, "Select at least one"),
        exercise_type: z.string().min(1, "Required"),
        exercise_duration: z.string().min(1, "Required"),
        sleep_duration: z.string().min(1, "Required"),
    }),
    diagnosis_plan: z.object({
        nutritional_diagnosis: z.string().min(1, "Required"),
        counselling_summary: z.string().min(1, "Required"),
        follow_up_plan: z.string().min(1, "Required"),
    }),
});
